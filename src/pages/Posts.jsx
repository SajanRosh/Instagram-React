...
function Posts() {
  ...
  return (
    <div>
        <div>
            {
                user != null ?  <div className='w-[500px] mx-auto my-16'>
                <div>
                {
                    <UserCard img={user.image} name={user.name} prof={user.profession}></UserCard>
                }
                </div>
                <div className='mt-7'>
                    ...
                    <p className='mt-1 text-neutral-600'>{new Date(post.postedDate).toLocaleDateString('en',options)}</p>
                </div>
            </div> : <Error></Error>
            }   
        </div>
        
        {/* <div className='w-[500px] mx-auto my-16'>
            <div>
            {
                <UserCard img={user.image} name={user.name} prof={user.profession}></UserCard>
            }
